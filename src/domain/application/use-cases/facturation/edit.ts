...
type UseCaseResponse = Either<ResourceNotFoundError | UnauthorizedError | ResourceNotFoundError, object>;
...
export class EditFacturationUseCase
{
    ...
    }: UseCaseRequest): Promise<UseCaseResponse>
    {
        ...
        if (isMemberOfEquinoccioNetwork !== undefined)
            facturation.isMemberOfEquinoccioNetwork = isMemberOfEquinoccioNetwork;
