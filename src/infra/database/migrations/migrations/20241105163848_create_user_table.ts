...
export async function up(db: Kysely<any>)
{
    await db.schema
        ...
        .addColumn("gender", ENUM("FEMENINO", "MASCULINO", "PREFIERO_NO_DECIR"), (col) =>
            col.defaultTo("PREFIERO_NO_DECIR").notNull(),
        )
        .addColumn("role", ENUM("ADMINISTRADOR", "ESTUDIANTE", "INSTRUCTOR"), (col) =>
            col.defaultTo("ESTUDIANTE").notNull(),
        )
