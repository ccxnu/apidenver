...
CREATE TABLE IF NOT EXISTS dnv_test_items (
  ...
  tti_description TEXT NOT NULL,  tti_percentile_25 SMALLINT NOT NULL, tti_percentile_50 SMALLINT NOT NULL, tti_percentile_75 SMALLINT NOT NULL, tti_percentile_90 SMALLINT NOT NULL, tti_item_type TEXT NOT NULL default 'Observado',
